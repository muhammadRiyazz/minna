...
// class PssengerBookingDetailPage5 extends StatefulWidget {
...
//   }) : super(key: key);
//   String tripId, dpName, bpName;
//   List<ListOfSeatClass> listSeat;
//   String bPid;
//   String tripIdees;

//   @override
//   State<PssengerBookingDetailPage5> createState() =>
//       _PssengerBookingDetailPage5State();
// }

// class _PssengerBookingDetailPage5State
//     extends State<PssengerBookingDetailPage5> {
...
//     var finalPrice = price1 + price2 + price3 + price4 + price5;
//     return Scaffold(
//       appBar: AppBar(
...
//                     var _resPonse5 =
//                         await BlocTicketEvetApiClass().getDataBLocTicket5(
...
// //PdDDAZDJG7
//                     _resPonse5.toString().characters.length.toInt() <= 12
...
//                     test: '\u{20B9} ${finalPrice} Pay now    '),
//                 style: ButtonStyle(
