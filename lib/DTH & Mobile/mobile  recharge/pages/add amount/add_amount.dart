          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  isSuccess ? 'Your mobile recharge was successful.' : message,
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text('Amount Paid', style: TextStyle(color: textSecondary, fontWeight: FontWeight.w600)),
                          Text('₹$amount', style: TextStyle(color: maincolor1, fontWeight: FontWeight.w900, fontSize: 18)),
                        ],
                      ),
                    ],
                  ),
  ...
  Widget _buildDetailRow(String title, String value) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          Text(title, style: TextStyle(color: textSecondary, fontWeight: FontWeight.w500, fontSize: 13)),
          Text(value, style: TextStyle(color: maincolor1, fontWeight: FontWeight.w700, fontSize: 14)),
        ],
      ),
    );
  }
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                    bottom: 60,
                    left: -20,
                    child: Icon(Icons.payment_rounded, size: 120, color: Colors.white.withOpacity(0.03)),
                  ),
                  SafeArea(
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Text(
                              'Secure Payment',
                              style: TextStyle(color: secondaryColor, fontSize: 12, fontWeight: FontWeight.w900, letterSpacing: 1),
                            ),
                          ),
                        ],
                      ),
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Column(
                            children: [
                              _buildSummaryItem(Icons.phone_iphone_rounded, 'Operator', widget.operator),
                              const Divider(height: 32),
                              _buildSummaryItem(Icons.call_rounded, 'Mobile Number', widget.phoneNo),
                            ],
                          ),
                        ),
                        const SizedBox(height: 24),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text('₹', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900, color: maincolor1)),
                                    ...
                                    SizedBox(
                                      ...
                                      child: TextField(
                                        ...
                                        textAlign: TextAlign.center,
                                        style: TextStyle(fontSize: 40, fontWeight: FontWeight.w900, color: maincolor1, letterSpacing: -1),
              ...
              child: Container(
                ...
                child: BlocBuilder<RechargeProceedBloc, RechargeProceedState>(
                  builder: (context, state) {
                    final bool isLoading = state.isLoading || _isPaymentInProgress;
                    return SizedBox(
                      width: double.infinity,
                      height: 65,
                      child: ElevatedButton(
  ...
  Widget _buildSummaryItem(IconData icon, String title, String value) {
    return Row(
      children: [
        Container(
          padding: const EdgeInsets.all(10),
          decoration: BoxDecoration(color: maincolor1.withOpacity(0.05), borderRadius: BorderRadius.circular(12)),
        ...
        Column(
          ...
          children: [
            ...
            Text(value, style: TextStyle(color: maincolor1, fontSize: 16, fontWeight: FontWeight.w800)),
          ],
        ),
      ],
    );
