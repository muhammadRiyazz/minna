...
class _AmountEntryPageState extends State<AmountEntryPage> {
  ...
  Future<void> _onProceed() async {
    ...
    // If logged in, proceed with recharge
    // context.read<RechargeProceedBloc>().add(
    //   RechargeProceedEvent.proceed(
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<RechargeProceedBloc, RechargeProceedState>(
      listener: (context, state) {
        if (!state.isLoading && state.rechargeStatus != null) {
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: state.isLoading ? null : _onProceed,
