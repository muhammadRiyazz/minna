...
class WalletService {
  ...
  static Future<Map<String, dynamic>> checkWalletBalance(
      ...
      if (responseData['status'] == 'SUCCESS') {
        ...
        if (walletBalance >= amountRequired) {
          ...
          return {
            'success': false,
            'message':
                'Insufficient wallet balance. Available: ₹${walletBalance.toStringAsFixed(2)}, Required: ₹${amountRequired.toStringAsFixed(2)}',
          };
        }
      } else {
        return {
